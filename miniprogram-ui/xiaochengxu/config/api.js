var NewApiRootUrl = 'https://test-miniprogram.9h-sports.com/';
// var NewApiRootUrl = 'http://localhost:8180/api/';

module.exports = {
  IndexUrl: NewApiRootUrl + 'goodsinfo/index', //首页数据接口
  CatalogList: NewApiRootUrl + 'goodsinfo/index',  //分类目录全部分类数据接口
  CatalogCurrent: NewApiRootUrl + 'goodsinfo/index',  //分类目录当前分类数据接口
